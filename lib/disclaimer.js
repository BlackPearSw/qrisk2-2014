 ...
 */
module.exports = 'The initial version of this file, to be found at http://svn.clinrisk.co.uk/opensource/qrisk2, ' +
    'faithfully implements QRISK2-2014. ClinRisk Ltd. have released this code under the GNU Lesser General Public ' +
    'License to enable others to implement this algorithm faithfully. However, the nature of the GNU Lesser General ' +
    'Public License is such that we cannot prevent, for example, someone accidentally altering the coefficients, ' +
    'getting the inputs wrong, or just poor programming. ClinRisk Ltd. stress, therefore that it is the ' +
    'responsibility of the end user to check that the source that they receive produces the same results as the ' +
    'original code posted at http://svn.clinrisk.co.uk/opensource/qrisk2. Inaccurate implementation of risk scores ' +
