 ...
 */
var getValidationErrors = require('./validation').getValidationErrors;

module.exports = function(name, version, disclaimer, rules, calculate){
    return function(args) {
        ...
        function checkPreconditions() {
            ...
            var errors = getValidationErrors(args, rules);
            if (errors.length > 0) {
